...
ALTER TABLE IF EXISTS ONLY public.user_details DROP CONSTRAINT IF EXISTS pk_user_details_id CASCADE;

DROP TABLE IF EXISTS public.user_details;
CREATE TABLE user_details (
    id serial NOT NULL,
    user_id integer,
    num_of_asked_questions integer,
...
INSERT INTO question VALUES (1, '2017-04-29 09:19:00', 15, 9, 'Wordpress loading multiple jQuery Versions', 'I developed a plugin that uses the jquery booklet plugin (https://builtbywill.com/booklet/#/) this plugin binds a function to $ so I can call $(".myBook").booklet();
